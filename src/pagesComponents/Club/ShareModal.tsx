...
${shareUrl}`,
  ...
  return (
    <div
      className="flex flex-col md:w-[500px] w-full"
      style={{
        ...
        <div className="flex flex-col w-full my-8 space-y-4">
          <div className="flex flex-col md:flex-row items-center md:space-x-2 margin-auto space-y-2 md:space-y-0">
            ...
            >
              <Button
                variant="accent"
                className="w-full md:w-[150px] flex items-center justify-center hover:bg-white/80"
              >
          ...
          <Copy title="" text={shareUrl} link={shareUrl} />
        </div>
      </div>
    </div>
  );
