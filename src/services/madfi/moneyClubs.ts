...
export const WHITELISTED_UNI_HOOKS = {
  ...
  "TRADING_DAYS_HOOK": {
    label: "This Uniswap v4 hook reverts when markets are closed in New York, the greatest city in the world and the only place where financial markets exist.",
