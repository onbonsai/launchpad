...
const PROTOCOL_DEPLOYMENT_TESTNET = {
  ...
  lens: {
    ...
    RewardSwap: "0xaB7311a413a39C4F640D152Eec00f70eD3889066",
  },
};
...
const PROTOCOL_DEPLOYMENT_MAINNET = {
  ...
  lens: {
    ...
    RewardSwap: "0x3B539f9961A03548164d612dc5f44C70973433F7",
  },
};

export const PROTOCOL_DEPLOYMENT = IS_PRODUCTION ? PROTOCOL_DEPLOYMENT_MAINNET : PROTOCOL_DEPLOYMENT_TESTNET;

export const ACTION_HUB_ADDRESS = IS_PRODUCTION ? "0xc6D57Ee750Ef2ee017a9E985A0C4198bEd16A802" : "0xc6D57Ee750Ef2ee017a9E985A0C4198bEd16A802";
