  ...
  const updateCredits = async (txHash: `0x${string}`) => {
    try {
      ...
      >
          ...
          <p>{customSubheader || "Generate smart media using our genAI studio. Credits purchased will be saved to your account balance."}</p>
        </div>
        ...
        {topUpOptions.map((option, index) => (
          ...
          >
            ...
            <div className={clsx(
              "flex items-center gap-2 sm:flex-col",
              option.isMaxMode ? "p-2 sm:p-3" : ""
            )}>
              ...
              <div className="text-left sm:text-center">
                ...
                <div className="text-xs sm:text-sm flex items-center gap-2">
                  ...
                  <div className={clsx(
                    option.isMaxMode ? "text-brand-highlight font-semibold" : "text-gray-400"
                  )}>
