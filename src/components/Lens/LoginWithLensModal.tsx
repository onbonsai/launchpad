...
import { getChain, LENS_BONSAI_APP } from "@src/services/madfi/utils";
...
import { USDC_CONTRACT_ADDRESS, USDC_DECIMALS, queryAvailableHandles } from "@src/services/madfi/moneyClubs";
...
const LoginWithLensModal = ({ closeModal, modal }: { closeModal: () => void; modal?: string }) => {
  ...
  const [creationStep, setCreationStep] = useState("create");
  ...
  }, [modal, isAuthenticated, isMiniApp]);
  ...
  useEffect(() => {
    if (selectedProfile?.address) {
      if (authenticatedProfileId) {
        console.log(`USEFFECT ON DISCONNECT`);
        lensLogout().then(fullRefetch);
  ...
  const handleCreateNewProfile = async () => {
    ...
    try {
      ...
      if (profilePicture.length > 0) {
        picture = await cacheImageToStorj(profilePicture[0], selectedHandle, "profile-images");
      }
    ...
    <div className={clsx("flex flex-col w-full mt-10 px-4", brandFont.className)}>
      {creationStep === "notifications" && isStandalone ? (
        <>
          ...
          <p className="text-center text-gray-400 mt-2">Complete your onboarding and receive your welcome gift!</p>
          ...
          <div className="flex flex-col items-center mt-6 mb-6">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Enable notifications to receive updates about your content and claim your{" "}
                <span className="text-[#5be39d] font-semibold">1000 BONSAI tokens</span> welcome bonus!
              </p>
          ...
          <div className="flex flex-col gap-3 mt-6 w-full pb-4">
            ...
            <Button className="w-full px-3 py-2 text-sm" onClick={handleCloseModal} variant="secondary">
              Skip for now
            </Button>
          </div>
        </>
            ...
            {!profiles || !profiles.length ? (
              !showCreateFlow ? (
                <div className="w-full items-center text-center">
                  ...
                  <Button variant="accent" onClick={() => setShowCreateFlow(true)} className="w-full mb-4">
                    Create Profile
                  </Button>
                ...
                <div className="w-full">
                  ...
                  <div className="flex flex-col items-center justify-center mb-6">
                    <div className="relative w-full max-w-xs flex items-center justify-center" style={{ height: 40 }}>
                      {/* Connecting line */}
                      <div
                        className="absolute top-1/2 left-0 right-0 h-0.5 bg-gray-600 z-0"
                    ...
                    <div className="text-center">
                      ...
                      <div className="relative mb-4">
                        ...
                        <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                          {isCheckingHandle && <Spinner customClasses="h-5 w-5" color="#5be39d" />}
                      ...
                      {handleError && <p className="text-bearish text-sm mb-4">{handleError}</p>}
                  ...
                  {createStep === 2 && (
                    <div className="text-center">
                      ...
                      <div className="flex gap-3">
                        <Button onClick={() => setCreateStep(1)} variant="secondary" className="flex-1">
                          Back
                        </Button>
                        <Button
                  ...
                  {createStep === 3 && (
                    <div className="text-center">
                      ...
                      <div className="rounded-lg p-6 mb-6">
                        <div className="flex items-center gap-4 mb-6">
                          <div className="w-16 h-16 flex-shrink-0">
                            <ImageUploader files={profilePicture} setFiles={setProfilePicture} maxFiles={1} compact />
                          </div>
                      ...
                      <div className="flex gap-3">
                        <Button onClick={() => setCreateStep(2)} variant="secondary" className="flex-1">
                          Back
                        </Button>
                        <Button
