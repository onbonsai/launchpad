    ...
    <div className="bg-background text-secondary min-h-[90vh]">
      <main className="mx-auto max-w-full md:max-w-[80rem] px-4 sm:px-2 lg:px-8">
        <div className="md:flex-row md:items-baseline md:justify-between border-b border-dark-grey pt-12 pb-4">
          <h1 className="text-3xl md:text-5xl font-bold font-owners tracking-wide mb-4 md:mb-0">Privacy Policy</h1>
        ...
        <section aria-labelledby="dashboard-heading" className="pt-8 pb-24 max-w-full">
          <div className="md:pl-12 md:pr-12 md:pb-12 pl-2 pr-2 pb-2">
            <section className="mt-4 max-w-screen-lg">
              ...
              <h2 className="text-2xl mt-4">Interpretation and Definitions</h2>
              <h3 className="text-lg mt-4">Interpretation</h3>
              <p>
              ...
              <h3 className="text-lg mt-4">Definitions</h3>
              ...
              <ul className="list-disc list-inside space-y-4">
                ...
                <li>
                  ...
                  refers to Bonsai Labs DAO, Corp., 30 N Gould St Ste R, Sheridan, Sheridan County, WY 82801, USA.
                </li>
                <li>
              ...
              <h2 className="text-2xl mt-4">Collecting and Using Your Personal Data</h2>
              <h3 className="text-lg mt-4">Types of Data Collected</h3>
              <h4>Personal Data</h4>
              <p>
              ...
              <h3 className="text-lg mt-4">Use of Your Personal Data</h3>
              ...
              <h3 className="text-lg mt-4">Retention of Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-lg mt-4">Transfer of Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-lg mt-4">Delete Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-lg mt-4">Disclosure of Your Personal Data</h3>
              ...
              <h3 className="text-lg mt-4">Security of Your Personal Data</h3>
              <p>
              ...
              <h2 className="text-2xl mt-4">Children's Privacy</h2>
              <p>
              ...
              <h2 className="text-2xl mt-4">Links to Other Websites</h2>
              <p>
              ...
              <h2 className="text-2xl mt-4">Changes to this Privacy Policy</h2>
              <p>
