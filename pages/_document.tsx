    ...
    return (
      <Html lang="en" className="w-full h-full bg-background">
        <Head>
          ...
          <meta property="og:description" content="Create AI-powered content on Bonsai — build and monetize your own Smart Media in minutes." />
          ...
          <meta name="twitter:description" content="Create AI-powered content on Bonsai — build and monetize your own Smart Media in minutes." />
